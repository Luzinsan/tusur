...
import imageio
from sympy import Interval, minimum, maximum
...
class Expression:
    ...
    def dichotomy(self):
        ...
        while true:
            ...
            images.append(
                imageio.imread(f'../minimization_of_a_unimodal_function/Plots/dichotomy/dichotomy{counter}.png'))
            counter += 1
        ...
        imageio.mimsave('../minimization_of_a_unimodal_function/gifs/dichotomy.gif', images, duration=0.5)
    ...
    def golden_ratio(self):
        ...
        while true:
            ...
            images.append(
                imageio.imread(f'../minimization_of_a_unimodal_function/Plots/golden_ratio/golden_ratio{counter}.png'))
            counter += 1
            # self.show_plot()
            if abs(end_curr - start_curr) / 2 < self.__eps \
                    and abs(self.__function.subs(x, x_curr).evalf()
        ...
        self.__x_min = x_curr
        self.__y_min = self.__function.subs(x, x_curr).evalf()
        imageio.mimsave('../minimization_of_a_unimodal_function/gifs/golden_ratio.gif', images, duration=0.5)
        return (self.__x_min, self.__y_min), counter
    ...
    def newton_init(self, type=0, x_curr=None):
        ...
        imageio.mimsave(f'../minimization_of_a_unimodal_function/gifs/{type_str}.gif', images, duration=0.5)
    ...
    def bolzano(self):
        ...
        while true:
            ...
            images.append(
                imageio.imread(f'../minimization_of_a_unimodal_function/Plots/bolzano/bolzano{counter}.png'))
            counter += 1
            if abs(end_curr - start_curr) / 2 < self.__eps \
                    and abs(self.__function.subs(x, x_curr).evalf()
                            - self.__function.subs(x, x_prev).evalf()) < self.__eps:
        ...
        self.__x_min = x_curr
        self.__y_min = self.__function.subs(x, x_curr).evalf()
        imageio.mimsave('../minimization_of_a_unimodal_function/gifs/bolzano.gif', images, duration=0.5)
        return self.__x_min, self.__y_min, counter
